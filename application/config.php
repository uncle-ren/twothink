...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => 'sKh|(mVRad.7^;X92qMyp)w~[AP3B1TEF$NS*J"n', //默认数据加密KEY
	'data_cache_key'=> 'sKh|(mVRad.7^;X92qMyp)w~[AP3B1TEF$NS*J"n',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'sKh|(mVRad.7^;X92qMyp)w~[AP3B1TEF$NS*J"n', //加密KEY
