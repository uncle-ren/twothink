...
class  Bianminfuwu extends Home
{
    ...
    Public function listbianmin(){
            //查询数据
        $lists = Db::table('document')->where(["category_id"=>47,"status"=>"1"])->select();
    ...
    Public function noticedetail($id){
        //根据id查找小区通知
       // var_dump(   time());
        $lists = Db::table('document_article')->where("id",$id)->select();
        var_dump($lists);
