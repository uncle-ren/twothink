        ...
        <div class="bs-example bs-example-tabs" data-example-id="togglable-tabs">
            ...
            <div id="myTabContent" class="tab-content">
                <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
                    ...
                    <div class="row">
                        <?php if(is_array($_zu) || $_zu instanceof \think\Collection || $_zu instanceof \think\Paginator): $i = 0; $__LIST__ = $_zu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <a href="noticedetail?id=<?php echo $vo['id']; ?>">
                        <div class="col-xs-6 col-md-4">
                            <div class="thumbnail">
                                <img src="__ROOT__<?php echo get_cover_path($vo['cover_id']); ?>" alt="...">
                                <div class="caption">
                ...
                <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
                    ...
                    <p class="text-danger">免费提供小区内的售房信息</p>
                    <div class="row">
                        <?php if(is_array($_shou) || $_shou instanceof \think\Collection || $_shou instanceof \think\Paginator): $i = 0; $__LIST__ = $_shou;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?>
                        <a href="noticedetail?id=<?php echo $vol['id']; ?>">
                        <div class="col-xs-6 col-md-4">
                            <div class="thumbnail">
                                <img src="__ROOT__<?php echo get_cover_path($vol['cover_id']); ?>" alt="...">
                                <div class="caption">
