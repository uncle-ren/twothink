<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\jdk\public/../application/admin/view/default/xiaoquactivity\add.html";i:1511938266;s:64:"D:\jdk\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <form action="<?php echo url('save'); ?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="date" class="text input-large" name="starttime" value="">
            </div>
        </div>
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="date" class="text input-large" name="endtime" value="">
            </div>
        </div>

        <div class="form-item">
            <label class="item-label">内容(请详细说明活动内容)<span class="check-tips"></span></label>
            <div class="controls">
