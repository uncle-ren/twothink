<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"D:\jdk\public/../application/admin/view/default/wuyeguanli\edit.html";i:1511746768;s:64:"D:\jdk\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <form action="<?php echo url('saveedit'); ?>" method="post" class="form-horizontal">
        <div class="form-item">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="tel" value="<?php echo $data['tel']; ?>">
            </div>
        </div>
        ...
        <div class="form-item">
            <label class="item-label">标题(请简述报修问题)<span class="check-tips"></span></label>
            <div class="controls">
        ...
        <div class="form-item">
            <label class="item-label">内容(请详细说明报修问题)<span class="check-tips"></span></label>
            <div class="controls">
                <textarea name="question" id="" cols="30" rows="10" ><?php echo $data['question']; ?></textarea>
            </div>
        </div>
