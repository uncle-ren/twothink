<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\jdk\public/../application/admin/view/default/xiaoquactivity\listwuye.html";i:1511937018;s:64:"D:\jdk\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="cf">
    <div class="fl">
        <a class="btn" href="<?php echo url('add'); ?>">添　加</a>
    ...
    <div class="search-form fr cf">
        <div class="sleft">
            <input type="text" name="nickname" class="search-input" value="<?php echo input('nickname'); ?>" placeholder="请输入报修人姓名或者报修单号">
...
<div class="data-table table-striped">
    <table class="">
        ...
        <tr>
            ...
            <td>
                <a href="<?php echo url('Wuyeguanli/edit?id='.$vo['id']); ?>" class="authorize">修改</a>
                <a href="<?php echo url('Wuyeguanli/del?id='.$vo['id']); ?>" class="confirm ajax-get">删除</a>
            </td>
        </tr>
