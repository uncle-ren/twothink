<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"D:\jdk\public/../application/home/view/default/yezhurenzheng\yezhurenzheng.html";i:1512058065;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
        <form action="saveform" method="post">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="guanxi">
                    <option>本人</option>
                    <option>亲属</option>
                    <option>租户</option>
                </select>
