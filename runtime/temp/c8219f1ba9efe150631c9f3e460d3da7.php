<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\jdk\public/../application/home/view/default/onlineweixiu\notice.html";i:1511923817;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
        <div class="row noticeList">
            <a href="noticedetail?id=<?php echo $vo['id']; ?>">
                <div class="col-xs-2">
                    <img class="noticeImg" src="../../index/china.jpg" />
                </div>
                <div class="col-xs-10">
                    <p class="title"><?php echo $vo['title']; ?></p>
                    <p class="intro"><?php echo $vo['content']; ?></p>
                    <p class="info">浏览: <?php echo $vo['views']; ?> <span class="pull-right"><?php echo time_format($vo['create_time']); ?></span> </p>
                </div>
            </a>
        </div>
