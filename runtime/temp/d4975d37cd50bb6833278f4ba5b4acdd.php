<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\jdk\public/../application/home/view/default/xiaoquactivity\notice.html";i:1512012863;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<script>
    $(".page").click(function () {
        ...
        $(this).attr('page',++page);
        $.get("/home/xiaoquactivity/ajax",{'page':page},function (data) {
            console.debug(data);
